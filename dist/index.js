    ...
    return {
        ...
        hooks: {
            ...
            "astro:build:done": async ({ dir, routes }) => {
                ...
                await Promise.all(filteredRoutes.map(async (route) => {
                    ...
                    const templateApplied = Object.keys(frontmatter).reduce((html, property) => {
                    ...
                    const opengraphImageDistPath = route.distURL?.pathname.replace("index.html", "opengraph-image.png");
